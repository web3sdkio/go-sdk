...
### func \(\*MarketplaceEncoder\) [ApproveBuyoutListing](<https://github.com/web3sdkio/go-sdk/blob/main/web3sdkio/marketplace_encoder.go#L119-L125>)
...
### func \(\*MarketplaceEncoder\) [ApproveCreateListing](<https://github.com/web3sdkio/go-sdk/blob/main/web3sdkio/marketplace_encoder.go#L257>)
...
### func \(\*MarketplaceEncoder\) [BuyoutListing](<https://github.com/web3sdkio/go-sdk/blob/main/web3sdkio/marketplace_encoder.go#L183-L189>)
...
### func \(\*MarketplaceEncoder\) [CancelListing](<https://github.com/web3sdkio/go-sdk/blob/main/web3sdkio/marketplace_encoder.go#L80>)
...
### func \(\*MarketplaceEncoder\) [CreateListing](<https://github.com/web3sdkio/go-sdk/blob/main/web3sdkio/marketplace_encoder.go#L302>)
...
## type [MarketplaceFilter](<https://github.com/web3sdkio/go-sdk/blob/main/web3sdkio/types.go#L515-L520>)
...
## type [MerkleContent](<https://github.com/web3sdkio/go-sdk/blob/main/web3sdkio/snapshots.go#L34-L36>)

```go
type MerkleContent struct {}
```

### func \(MerkleContent\) [CalculateHash](<https://github.com/web3sdkio/go-sdk/blob/main/web3sdkio/snapshots.go#L38>)

```go
func (t MerkleContent) CalculateHash() ([]byte, error)
```

### func \(MerkleContent\) [Equals](<https://github.com/web3sdkio/go-sdk/blob/main/web3sdkio/snapshots.go#L47>)

```go
func (t MerkleContent) Equals(other merkletree.Content) (bool, error)
```

## type [MerkleNode](<https://github.com/web3sdkio/go-sdk/blob/main/web3sdkio/sharded_merkle_tree.go#L259-L261>)

```go
type MerkleNode struct {}
```

### func \(\*MerkleNode\) [Serialize](<https://github.com/web3sdkio/go-sdk/blob/main/web3sdkio/sharded_merkle_tree.go#L263>)

```go
func (t *MerkleNode) Serialize() ([]byte, error)
```

## type [Metadata](<https://github.com/web3sdkio/go-sdk/blob/main/web3sdkio/types.go#L17-L20>)
