...
var storageUploadCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		uri, err := storage.Upload(&web3sdkio.NFTMetadataInput{
			Name:        "Test NFT 1",
...
var storageUploadBatchCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		uriWithBaseUris, err := storage.UploadBatch(
			[]interface{}{
				&web3sdkio.NFTMetadataInput{Name: "Test NFT 2", Description: "Description 2"},
				&web3sdkio.NFTMetadataInput{Name: "Test NFT 3", Description: "Description 3"},
			},
			0,
			"",
			"",
