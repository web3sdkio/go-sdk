...
// Web3sdkioFee is a free data retrieval call binding the contract method 0xcf8267b1.
//
// Solidity: function web3sdkioFee() view returns(address)
func (_TokenERC1155 *TokenERC1155Caller) Web3sdkioFee(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TokenERC1155.contract.Call(opts, &out, "web3sdkioFee")
...
//
// Solidity: function web3sdkioFee() view returns(address)
func (_TokenERC1155 *TokenERC1155Session) Web3sdkioFee() (common.Address, error) {
	return _TokenERC1155.Contract.Web3sdkioFee(&_TokenERC1155.CallOpts)
}

// Web3sdkioFee is a free data retrieval call binding the contract method 0xcf8267b1.
//
// Solidity: function web3sdkioFee() view returns(address)
func (_TokenERC1155 *TokenERC1155CallerSession) Web3sdkioFee() (common.Address, error) {
	return _TokenERC1155.Contract.Web3sdkioFee(&_TokenERC1155.CallOpts)
}
