...
func (_TokenERC721 *TokenERC721Caller) Web3sdkioFee(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TokenERC721.contract.Call(opts, &out, "web3sdkioFee")
...
//
// Solidity: function web3sdkioFee() view returns(address)
func (_TokenERC721 *TokenERC721Session) Web3sdkioFee() (common.Address, error) {
	return _TokenERC721.Contract.Web3sdkioFee(&_TokenERC721.CallOpts)
}

// Web3sdkioFee is a free data retrieval call binding the contract method 0xcf8267b1.
//
// Solidity: function web3sdkioFee() view returns(address)
func (_TokenERC721 *TokenERC721CallerSession) Web3sdkioFee() (common.Address, error) {
	return _TokenERC721.Contract.Web3sdkioFee(&_TokenERC721.CallOpts)
}
