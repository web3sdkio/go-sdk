...
func (_Marketplace *MarketplaceCaller) Web3sdkioFee(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Marketplace.contract.Call(opts, &out, "web3sdkioFee")
...
//
// Solidity: function web3sdkioFee() view returns(address)
func (_Marketplace *MarketplaceSession) Web3sdkioFee() (common.Address, error) {
	return _Marketplace.Contract.Web3sdkioFee(&_Marketplace.CallOpts)
}

// Web3sdkioFee is a free data retrieval call binding the contract method 0xcf8267b1.
//
// Solidity: function web3sdkioFee() view returns(address)
func (_Marketplace *MarketplaceCallerSession) Web3sdkioFee() (common.Address, error) {
	return _Marketplace.Contract.Web3sdkioFee(&_Marketplace.CallOpts)
}
